...
class MapGenerator {
	...
	protected static MapGenerator getGenerator() {
		return new MapGenerator();
	}
	
	protected MapGenerator withSize(int width, int height) {
	...
	protected MapGenerator withDensity(float density) {
	...
	protected MapGenerator withConnectivity(float connectivity) {
	...
	protected boolean[][] generate(long seed) {
